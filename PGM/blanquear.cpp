...
/**
 * @file blanquear.cpp
 * @brief Código fuente para blanquear archivos PGM.
 * 
 * Detalles.
 * 
 * En este fichero fuente se encuentra el código necesario para blanquear imágenes codificadas en archivos .pgm. Las dimesiones máximas de la imagen deben ser 650x650, 
 ...
 * 
 * Esta clase permite leer y escribir ficheros .pgm desde la E/S estándar, incluye un método para blanquear la imagen. 
